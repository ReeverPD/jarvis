...
<head> 
    ...
    <!-- main stylesheet -->
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/css/jarvis.css">
...
<body class="bg_f">
    ...
    <!-- main wrapper (without footer) -->
        ...
        <!-- header -->
            <header>
                <div class="container">
                    <div class="row">
                        <div class="span3">
                            <div class="main-logo"><a href="${pageContext.servletContext.contextPath}/app/home"><img src="${pageContext.servletContext.contextPath}/resources/img/jarvis_logo.png" alt="J.A.R.V.I.S OPEC"></a></div>
                        </div>
                        <div class="span5">
                            <nav class="nav-icons">
                                <ul>
        ...
        <!-- breadcrumbs -->
            <div class="container">
                <ul id="breadcrumbs">
                    <li><a href="javascript:void(0)" url="/app/home"><i class="icon-home"></i></a></li>
                    <c:forEach var="item" items="${breadcrumbItems}">
    ...
    <!-- Common JS -->
        ...
        <!-- common functions -->
            <script src="${pageContext.servletContext.contextPath}/resources/js/jarvis_common.js"></script>


        <!-- Head Footer Section -->
        <sitemesh:write property='page.footerLay'/>
